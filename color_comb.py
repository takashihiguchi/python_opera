...
def contour_cut(fig, ax, lab_tgt, lab_ind, zmin, zmax):
    cont20 = tricont_sub(ax[0],pl_0x_cm.y, pl_0x_cm.z, pl_0x[lab_tgt], zmin, zmax, 31, lab_ind)
    cont21 = tricont_sub(ax[1],pl_0y_cm.x, pl_0y_cm.z, pl_0y[lab_tgt], zmin, zmax, 31, lab_ind)
    cont22 = tricont_sub(ax[2],pl_0z_cm.x, pl_0z_cm.y, pl_0z[lab_tgt], zmin, zmax, 31, lab_ind)
...
cbar1x = cbar_dice(fig1x, ax1x, cont1x, [Bx_minpm, Bx_maxpm], 10) 
dice(ax1x)
...
sct1x = sct_dice(ax1xs, lab_tgt, lab_ind, Bx_minpm, Bx_maxpm)
sct1x.set_clim(Bx_minpm, Bx_maxpm)
cbar1xs = cbar_dice(fig1xs, ax1xs, sct1x, [Bx_minpm, Bx_maxpm], 10) 
dice(ax1xs)
...
cbar1y = cbar_dice(fig1y, ax1y, cont1y, [By_minpm, By_maxpm], 10 )
dice(ax1y)
...
sct1y = sct_dice(ax1ys, lab_tgt, lab_ind, By_minpm, By_maxpm)
sct1y.set_clim(By_minpm, By_maxpm)
cbar1ys = cbar_dice(fig1ys, ax1ys, sct1y, [By_minpm, By_maxpm], 10)
dice(ax1ys)
...
cbar1z = cbar_dice(fig1z, ax1z, cont1z, [Bz_minpm, Bz_maxpm], 10)
dice(ax1z)
...
sct1z = sct_dice(ax1zs, lab_tgt, lab_ind, Bz_minpm, Bz_maxpm)
sct1z.set_clim(Bz_minpm, Bz_maxpm)
cbar1zs = cbar_dice(fig1zs, ax1zs, sct1z, [Bz_minpm, Bz_maxpm], 10)
dice(ax1zs)
...
cbar1n = cbar_dice(fig1n, ax1n, cont1n, [B_minpm, B_maxpm], 10)
dice(ax1n)
...
sct1n = sct_dice(ax1ns, lab_tgt, lab_ind, B_minpm, B_maxpm)
sct1n.set_clim(B_minpm, B_maxpm)
cbar1ns = cbar_dice(fig1ns, ax1ns, sct1n,[-B_maxpm, B_maxpm], 10)
dice(ax1ns)
